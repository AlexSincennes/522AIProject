...
#include "PrimeEngine/GameObjectModel/PhysicsComponent.h"
using namespace PE;
...
SoldierNPC::SoldierNPC(PE::GameContext &context, PE::MemoryArena arena, PE::Handle hMyself, Event_CreateSoldierNPC *pEvt) : Component(context, arena, hMyself)
{
	...
	//	Array<PrimitiveTypes::Float32>  e = pMeshCaller->minValues;
		PhysicsComponent *pMainPC = new(hPC)PhysicsComponent(*m_pContext, m_arena, hPC, pMeshCaller->minValues, pMeshCaller->maxValues, pEvt->m_meshFilename, pSN->m_base.getPos());
