	...
	// start root
	{
		...
		// start root.CharacterControl
		{
			...
			// start root.CharacterControl.Events
			{
				...
				Event_CreateA6Character::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				A6cAnimSM_Event_RUN::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
