-- this is game object script for a Imrod object of CharacterControl demo
...
outputDebugString("Executing Imrod.lua")
function runScript(args)
    local pos = args['base']['pos']
    local u = args['base']['u']
    local v = args['base']['v']
    local n = args['base']['n']
    evt = root.CharacterControl.Events.Event_CreateA6Character.Construct(l_getGameContext(),
